...
func (m *MessageLinkedCorp) SendTextQyLinkedCorp(accessToken string, req SendTextQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
...
func (m *MessageLinkedCorp) SendImageQyLinkedCorp(accessToken string, req SendImageQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendVoiceQyLinkedCorp(accessToken string, req SendVoiceQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendVideoQyLinkedCorp(accessToken string, req SendVideoQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendFileQyLinkedCorp(accessToken string, req SendFileQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendTextCardQyLinkedCorp(accessToken string, req SendTextCardQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendNewsQyLinkedCorp(accessToken string, req SendNewsQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendMpNewsQyLinkedCorp(accessToken string, req SendMpNewsQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendMarkdownQyLinkedCorp(accessToken string, req SendMarkdownQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
...
func (m *MessageLinkedCorp) SendMiniprogramQyLinkedCorp(accessToken string, req SendMiniprogramQyLinkedCorpReq)(result *SendLinkedCorpRep, err error){
	qyUrl := fmt.Sprintf(SendQyLinkedCorpURL, accessToken)
